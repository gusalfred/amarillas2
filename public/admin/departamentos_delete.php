...
$departamentos_delete = NULL; // Initialize page object first

class cdepartamentos_delete extends cdepartamentos {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("departamentos_list.php"); // Prevent SQL injection, return to list
...
// Create page object
if (!isset($departamentos_delete)) $departamentos_delete = new cdepartamentos_delete();
...
$departamentos_delete->Page_Render();
?>
...
// Form object
var fdepartamentosdelete = new ew_Form("fdepartamentosdelete");

// Form_CustomValidate event
fdepartamentosdelete.Form_CustomValidate = 
...
fdepartamentosdelete.ValidateRequired = true;
<?php } else { ?>
fdepartamentosdelete.ValidateRequired = false; 
<?php } ?>
...
if ($departamentos_deleteTotalRecs <= 0) { // No record found, exit
	...
	$departamentos_delete->Page_Terminate("departamentos_list.php"); // Return to list
}
?>
<div class="ewToolbar">
...
?>
<form name="fdepartamentosdelete" id="fdepartamentosdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($departamentos_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $departamentos_delete->Token ?>">
<?php } ?>
...
<?php if ($departamentos->codigo_departamento->Visible) { // codigo_departamento ?>
		<th><span id="elh_departamentos_codigo_departamento" class="departamentos_codigo_departamento"><?php echo $departamentos->codigo_departamento->FldCaption() ?></span></th>
<?php } ?>
<?php if ($departamentos->departamento->Visible) { // departamento ?>
		<th><span id="elh_departamentos_departamento" class="departamentos_departamento"><?php echo $departamentos->departamento->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $departamentos_delete->RowCnt ?>_departamentos_codigo_departamento" class="departamentos_codigo_departamento">
...
<span id="el<?php echo $departamentos_delete->RowCnt ?>_departamentos_departamento" class="departamentos_departamento">
