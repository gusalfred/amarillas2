...
class clogin extends cempleados {
...
<?php } ?>
	<div class="form-group">
		...
		<div class="col-sm-10"><input type="text" name="username" id="username" class="form-control ewControl" value="<?php echo ew_HtmlEncode($login->Username) ?>"></div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="password"><?php echo $Language->Phrase("Password") ?></label>
		<div class="col-sm-10"><input type="password" name="password" id="password" class="form-control ewControl"></div>
	</div>
	<div class="form-group">
