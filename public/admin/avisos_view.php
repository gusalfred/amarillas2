...
$avisos_view = NULL; // Initialize page object first

class cavisos_view extends cavisos {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["id_aviso"] <> "") {
			$this->RecKey["id_aviso"] = $_GET["id_aviso"];
			$KeyUrl .= "&amp;id_aviso=" . urlencode($this->RecKey["id_aviso"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_aviso"] <> "") {
				...
				$this->RecKey["id_aviso"] = $this->id_aviso->QueryStringValue;
			} elseif (@$_POST["id_aviso"] <> "") {
				$this->id_aviso->setFormValue($_POST["id_aviso"]);
				$this->RecKey["id_aviso"] = $this->id_aviso->FormValue;
			} else {
				$sReturnUrl = "avisos_list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "avisos_list.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "avisos_list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($avisos_view)) $avisos_view = new cavisos_view();

// Page init
$avisos_view->Page_Init();

// Page main
$avisos_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$avisos_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var avisos_view = new ew_Page("avisos_view");
avisos_view.PageID = "view"; // Page ID
var EW_PAGE_ID = avisos_view.PageID; // For backward compatibility

// Form object
var favisosview = new ew_Form("favisosview");

// Form_CustomValidate event
favisosview.Form_CustomValidate = 
...
favisosview.ValidateRequired = true;
<?php } else { ?>
favisosview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
favisosview.Lists["x_id_empresa"] = {"LinkField":"x_id_empresa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_documento_tipo","x_documento_numero",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $avisos_view->ExportOptions->Render("body") ?>
<?php
	foreach ($avisos_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $avisos_view->ShowPageHeader(); ?>
<?php
$avisos_view->ShowMessage();
?>
<form name="favisosview" id="favisosview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($avisos_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $avisos_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="avisos">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($avisos->fecha->Visible) { // fecha ?>
	<tr id="r_fecha">
		<td><span id="elh_avisos_fecha"><?php echo $avisos->fecha->FldCaption() ?></span></td>
		<td<?php echo $avisos->fecha->CellAttributes() ?>>
<span id="el_avisos_fecha">
<span<?php echo $avisos->fecha->ViewAttributes() ?>>
<?php echo $avisos->fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($avisos->id_empresa->Visible) { // id_empresa ?>
	<tr id="r_id_empresa">
		<td><span id="elh_avisos_id_empresa"><?php echo $avisos->id_empresa->FldCaption() ?></span></td>
		<td<?php echo $avisos->id_empresa->CellAttributes() ?>>
<span id="el_avisos_id_empresa">
<span<?php echo $avisos->id_empresa->ViewAttributes() ?>>
<?php echo $avisos->id_empresa->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($avisos->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_avisos_nombre"><?php echo $avisos->nombre->FldCaption() ?></span></td>
		<td<?php echo $avisos->nombre->CellAttributes() ?>>
<span id="el_avisos_nombre">
<span<?php echo $avisos->nombre->ViewAttributes() ?>>
<?php echo $avisos->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($avisos->url_aviso->Visible) { // url_aviso ?>
	<tr id="r_url_aviso">
		<td><span id="elh_avisos_url_aviso"><?php echo $avisos->url_aviso->FldCaption() ?></span></td>
		<td<?php echo $avisos->url_aviso->CellAttributes() ?>>
<span id="el_avisos_url_aviso">
<span>
<?php echo ew_GetFileViewTag($avisos->url_aviso, $avisos->url_aviso->ViewValue) ?>
</span>
</span>
</td>
	</tr>
