...
$avisos_archivo_blobview = NULL; // Initialize page object first

class cavisos_archivo_blobview extends cavisos {
	...
	// Page object name
	var $PageObjName = 'avisos_archivo_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('avisos', 'x_archivo');
...
// Create page object
if (!isset($avisos_archivo_blobview)) $avisos_archivo_blobview = new cavisos_archivo_blobview();

// Page init
$avisos_archivo_blobview->Page_Init();

// Page main
$avisos_archivo_blobview->Page_Main();
?>
<?php
$avisos_archivo_blobview->Page_Terminate();
?>
