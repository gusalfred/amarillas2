...
class cempleados_list extends cempleados {
	...
	function __construct() {
		...
		$this->AddUrl = "empleados_add.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "empleados_delete.php";
		$this->MultiUpdateUrl = "empleados_update.php";
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->id_empleado->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'>";
...
fempleadoslist.Lists["x_id_empleado_nivel"] = {"LinkField":"x_id_empleado_nivel","Ajax":null,"AutoFill":false,"DisplayFields":["x_nivel","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($empleados_list->TotalRecs > 0 && $empleados_list->ExportOptions->Visible()) { ?>
<?php $empleados_list->ExportOptions->Render("body") ?>
<?php } ?>
...
<?php
	$bSelectLimit = EW_SELECT_LIMIT;
	if ($bSelectLimit) {
		if ($empleados_list->TotalRecs <= 0)
			$empleados_list->TotalRecs = $empleados->SelectRecordCount();
	} else {
		if (!$empleados_list->Recordset && ($empleados_list->Recordset = $empleados_list->LoadRecordset()))
	...
	if ($empleados->CurrentAction == "" && $empleados_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$empleados_list->setWarningMessage($Language->Phrase("NoPermission"));
		if ($empleados_list->SearchWhere == "0=101")
			$empleados_list->setWarningMessage($Language->Phrase("EnterSearchCriteria"));
		else
			$empleados_list->setWarningMessage($Language->Phrase("NoRecord"));
	}
...
?>
<?php if ($empleados_list->TotalRecs > 0 || $empleados->CurrentAction <> "") { ?>
<div class="ewGrid">
...
<form name="fempleadoslist" id="fempleadoslist" class="form-inline ewForm ewListForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($empleados_list->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $empleados_list->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="empleados">
<div id="gmp_empleados" class="<?php if (ew_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php if ($empleados_list->TotalRecs > 0) { ?>
<table id="tbl_empleadoslist" class="table ewTable">
...
// Header row
$empleados->RowType = EW_ROWTYPE_HEADER;
...
<?php if ($empleados->id_empleado_nivel->Visible) { // id_empleado_nivel ?>
	<?php if ($empleados->SortUrl($empleados->id_empleado_nivel) == "") { ?>
		<th data-name="id_empleado_nivel"><div id="elh_empleados_id_empleado_nivel" class="empleados_id_empleado_nivel"><div class="ewTableHeaderCaption"><?php echo $empleados->id_empleado_nivel->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_empleado_nivel"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleados->SortUrl($empleados->id_empleado_nivel) ?>',1);"><div id="elh_empleados_id_empleado_nivel" class="empleados_id_empleado_nivel">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $empleados->id_empleado_nivel->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($empleados->id_empleado_nivel->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($empleados->id_empleado_nivel->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($empleados->nombre->Visible) { // nombre ?>
	<?php if ($empleados->SortUrl($empleados->nombre) == "") { ?>
		<th data-name="nombre"><div id="elh_empleados_nombre" class="empleados_nombre"><div class="ewTableHeaderCaption"><?php echo $empleados->nombre->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nombre"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleados->SortUrl($empleados->nombre) ?>',1);"><div id="elh_empleados_nombre" class="empleados_nombre">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $empleados->nombre->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($empleados->nombre->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($empleados->nombre->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($empleados->usuario->Visible) { // usuario ?>
	<?php if ($empleados->SortUrl($empleados->usuario) == "") { ?>
		<th data-name="usuario"><div id="elh_empleados_usuario" class="empleados_usuario"><div class="ewTableHeaderCaption"><?php echo $empleados->usuario->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="usuario"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleados->SortUrl($empleados->usuario) ?>',1);"><div id="elh_empleados_usuario" class="empleados_usuario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $empleados->usuario->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($empleados->usuario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($empleados->usuario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($empleados->id_empleado_nivel->Visible) { // id_empleado_nivel ?>
		<td data-name="id_empleado_nivel"<?php echo $empleados->id_empleado_nivel->CellAttributes() ?>>
...
<a id="<?php echo $empleados_list->PageObjName . "_row_" . $empleados_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($empleados->nombre->Visible) { // nombre ?>
		<td data-name="nombre"<?php echo $empleados->nombre->CellAttributes() ?>>
<span<?php echo $empleados->nombre->ViewAttributes() ?>>
<?php echo $empleados->nombre->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($empleados->usuario->Visible) { // usuario ?>
		<td data-name="usuario"<?php echo $empleados->usuario->CellAttributes() ?>>
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $empleados_list->PageUrl() ?>start=<?php echo $empleados_list->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($empleados_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $empleados_list->PageUrl() ?>start=<?php echo $empleados_list->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $empleados_list->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($empleados_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $empleados_list->PageUrl() ?>start=<?php echo $empleados_list->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($empleados_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $empleados_list->PageUrl() ?>start=<?php echo $empleados_list->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $empleados_list->Pager->PageCount ?></span>
</div>
<div class="ewPager ewRec">
	<span><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $empleados_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $empleados_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $empleados_list->Pager->RecordCount ?></span>
</div>
<?php } ?>
</form>
<?php } ?>
...
<?php } ?>
<?php if ($empleados_list->TotalRecs == 0 && $empleados->CurrentAction == "") { // Show other options ?>
<div class="ewListOtherOptions">
<?php
	foreach ($empleados_list->OtherOptions as &$option) {
		$option->ButtonClass = "";
