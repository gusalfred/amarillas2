...
define("EW_PROJECT_NAME", "admin365", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{D02329FA-C783-46FA-A3B4-996FD9449799}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'dq0oujEd05fQs4et', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "css/admin365.css", TRUE); // Project stylesheet file name
...
// Language settings
define("EW_LANGUAGE_FOLDER", $EW_RELATIVE_PATH . "lang/", TRUE);
...
@define("EW_USER_LEVEL_TABLE", "`empleados_niveles`", TRUE);
@define("EW_USER_LEVEL_ID_FIELD", "`id_empleado_nivel`", TRUE);
@define("EW_USER_LEVEL_NAME_FIELD", "`nivel`", TRUE);

// User Level privileges table/field names
@define("EW_USER_LEVEL_PRIV_TABLE", "`empleados_permisos`", TRUE);
@define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD", "`tabla`", TRUE);
@define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD_2", "tabla", TRUE);
@define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD_SIZE", 255, TRUE);
@define("EW_USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD", "`id_empleado_nivel`", TRUE);
...
// User table filters
define("EW_USER_TABLE", "`empleados`",  TRUE);
...
define("EW_USER_PROFILE_FIELD_NAME", "perfil",  TRUE);
