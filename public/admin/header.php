...
<link rel="stylesheet" type="text/css" href="<?php echo $EW_RELATIVE_PATH ?>css/jquery.fileupload-ui.css">
...
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>js/typeahead.bundle.min.js"></script>
...
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>js/ewcalendar.js"></script>
...
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>js/jsrender.min.js"></script>
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>js/ewp11.js"></script>
<script type="text/javascript">
<?php echo $Language->ToJSON() ?>
</script>
<?php
ew_AddStylesheet("css/font-awesome.min.css");
ew_AddStylesheet("css/jquery.fancybox.css");
ew_AddClientScript("js/jquery.fancybox.pack.js");
ew_AddStylesheet("css/rateit.css");
ew_AddClientScript("js/rateit.min.js");
ew_AddClientScript("js/vue.min.js");
ew_AddStylesheet("css/global.css");
?>
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>js/userfn11.js"></script>
<script type="text/javascript">
$(document).ready(function() {
	document.title = 'Amarillas365';
	$('<link type="image/x-icon" rel="icon" href="images/favicon.png">').appendTo('head');
	$('.navbar-brand').text('Amarillas365');
	$(".fancybox").fancybox( {'minHeight':460, 'openSpeed':0 } );
	$("a.iframe2").fancybox({'autoScale':false,'width':830,'height':460,'type':'iframe'}); 
});
</script>
...
<div class="ewLayout">
	...
	<div id="ewHeaderRow" class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EW_RELATIVE_PATH ?>images/logo.png" alt=""></div>
<?php if (ew_IsResponsiveLayout()) { ?>
