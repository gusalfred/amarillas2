...
$empresas_valoraciones_edit = NULL; // Initialize page object first

class cempresas_valoraciones_edit extends cempresas_valoraciones {
	...
	// Page object name
	var $PageObjName = 'empresas_valoraciones_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->id_empresa_valoracion->CurrentValue == "")
			$this->Page_Terminate("empresas_valoraciones_list.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		if (!$this->id_empresa_valoracion->FldIsDetailKey)
			$this->id_empresa_valoracion->setFormValue($objForm->GetValue("x_id_empresa_valoracion"));
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->id_empresa_valoracion->CurrentValue = $this->id_empresa_valoracion->FormValue;
...
// Create page object
if (!isset($empresas_valoraciones_edit)) $empresas_valoraciones_edit = new cempresas_valoraciones_edit();

// Page init
$empresas_valoraciones_edit->Page_Init();

// Page main
$empresas_valoraciones_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$empresas_valoraciones_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var empresas_valoraciones_edit = new ew_Page("empresas_valoraciones_edit");
empresas_valoraciones_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = empresas_valoraciones_edit.PageID; // For backward compatibility

// Form object
var fempresas_valoracionesedit = new ew_Form("fempresas_valoracionesedit");

// Validate form
fempresas_valoracionesedit.Validate = function() {
...
fempresas_valoracionesedit.Form_CustomValidate = 
...
fempresas_valoracionesedit.ValidateRequired = true;
<?php } else { ?>
fempresas_valoracionesedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fempresas_valoracionesedit.Lists["x_id_empresa"] = {"LinkField":"x_id_empresa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fempresas_valoracionesedit.Lists["x_id_usuario"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $empresas_valoraciones_edit->ShowPageHeader(); ?>
<?php
$empresas_valoraciones_edit->ShowMessage();
?>
<form name="fempresas_valoracionesedit" id="fempresas_valoracionesedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($empresas_valoraciones_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $empresas_valoraciones_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fempresas_valoracionesedit.CreateAutoSuggest("x_id_empresa", false);
</script>
</span>
...
<script type="text/javascript">
fempresas_valoracionesedit.CreateAutoSuggest("x_id_usuario", false);
</script>
</span>
...
<input type="hidden" data-field="x_id_empresa_valoracion" name="x_id_empresa_valoracion" id="x_id_empresa_valoracion" value="<?php echo ew_HtmlEncode($empresas_valoraciones->id_empresa_valoracion->CurrentValue) ?>">
...
<script type="text/javascript">
fempresas_valoracionesedit.Init();
</script>
<?php
$empresas_valoraciones_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$empresas_valoraciones_edit->Page_Terminate();
?>
